...
namespace UsbSimulator
{
    public class UsbChargerSimulator : IUsbCharger
    {
        ...
        public event EventHandler<CurrentChangedEventArgs> CurrentValueEvent;
        ...
        {
            CurrentValueEvent?.Invoke(this, new CurrentChangedEventArgs() {Current = this.CurrentValue});
        }
    }
}
